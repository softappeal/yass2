...
private fun socketSession(testMode: TestMode, initiatorRunTests: Boolean, acceptorRunTests: Boolean) =
...
abstract class SocketTest {
    ...
    @Test
    fun socketTestException() = socketTest(TestMode.Exception)

    @Test
    fun socketSessionNormalFalseTrue() = socketSession(TestMode.Normal, initiatorRunTests = false, acceptorRunTests = true)

    @Test
    fun socketSessionNormalTrueFalse() = socketSession(TestMode.Normal, initiatorRunTests = true, acceptorRunTests = false)

    @Test
    fun socketSessionNormalTrueTrue() = socketSession(TestMode.Normal, initiatorRunTests = true, acceptorRunTests = true)

    @Test
    fun socketSessionExceptionFalseTrue() = socketSession(TestMode.Exception, initiatorRunTests = false, acceptorRunTests = true)

    @Test
    fun socketSessionExceptionTrueFalse() = socketSession(TestMode.Exception, initiatorRunTests = true, acceptorRunTests = false)
