...
public fun stringEncoders(): List<ch.softappeal.yass2.core.serialize.string.StringEncoder<*>> =
    listOf(
        ...
        ch.softappeal.yass2.core.serialize.string.ClassStringEncoder(
            ch.softappeal.yass2.coroutines.session.Packet::class, // 6
            { i ->
        ...
        ch.softappeal.yass2.core.serialize.string.ClassStringEncoder(
            ch.softappeal.yass2.core.remote.Request::class, // 7
            { i ->
        ...
        ch.softappeal.yass2.core.serialize.string.ClassStringEncoder(
            ch.softappeal.yass2.core.remote.ValueReply::class, // 8
            { i ->
        ...
        ch.softappeal.yass2.core.serialize.string.ClassStringEncoder(
            ch.softappeal.yass2.core.remote.ExceptionReply::class, // 9
            { i ->
        ...
        ch.softappeal.yass2.core.serialize.string.ClassStringEncoder(
            tutorial.DivideByZeroException::class, // 12
            { i ->
            },
            {
