...
import ch.softappeal.yass2.ksp.CONTRACT_KSP_PGM
...
class GeneratorTest {
    ...
    fun coverage() {
        val result = KotlinCompilation().apply {
            useKsp2()
            classpaths = listOf(
                File("../yass2-core/build/classes/kotlin/jvm/main"),
                File("../yass2-coroutines/build/classes/kotlin/jvm/main"),
                File("../yass2-ktor/build/classes/kotlin/jvm/test"),
            )
            sources = listOf(SourceFile.kotlin("Source.kt", CONTRACT_KSP_PGM))
            symbolProcessorProviders += Yass2Provider()
        }.compile()
