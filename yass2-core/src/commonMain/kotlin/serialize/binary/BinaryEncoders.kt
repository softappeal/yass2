...
public object BooleanBinaryEncoder : BinaryEncoder<Boolean>(Boolean::class,
    { value -> writeBinaryBoolean(value) },
    { readBinaryBoolean() }
)

public object IntBinaryEncoder : BinaryEncoder<Int>(Int::class,
    { value -> writeVarInt(value.toZigZag()) },
    { readVarInt().fromZigZag() }
)

public object LongBinaryEncoder : BinaryEncoder<Long>(Long::class,
    { value -> writeVarLong(value.toZigZag()) },
    { readVarLong().fromZigZag() }
)

public object DoubleBinaryEncoder : BinaryEncoder<Double>(Double::class,
    { value -> writeBinaryLong(value.toBits()) },
    { Double.fromBits(readBinaryLong()) }
)

public object ByteArrayBinaryEncoder : BinaryEncoder<ByteArray>(ByteArray::class,
    { value ->
...
public object StringBinaryEncoder : BinaryEncoder<String>(String::class,
