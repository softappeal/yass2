...
class WebSocketConnection internal constructor(private val config: TransportConfig, val session: WebSocketSession) : Connection {
...
suspend fun WebSocketSession.receiveLoop(config: TransportConfig, sessionFactory: SessionFactory) {
