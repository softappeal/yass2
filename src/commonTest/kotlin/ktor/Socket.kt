...
fun Serializer.tunnel(socketConnector: SocketConnector): Tunnel = { request ->
...
suspend fun Socket.handleRequest(serializer: Serializer, tunnel: Tunnel): Unit = use {
...
class SocketConnection internal constructor(
...
suspend fun Socket.receiveLoop(serializer: Serializer, sessionFactory: SessionFactory<SocketConnection>): Unit = use {
