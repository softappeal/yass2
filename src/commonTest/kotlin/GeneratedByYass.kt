...
public fun ch.softappeal.yass2.remote.ServiceId<ch.softappeal.yass2.Calculator>.proxy(
...
public fun ch.softappeal.yass2.remote.ServiceId<ch.softappeal.yass2.Calculator>.service(
...
public fun ch.softappeal.yass2.remote.ServiceId<ch.softappeal.yass2.Echo>.proxy(
    tunnel: ch.softappeal.yass2.remote.Tunnel,
...
public fun ch.softappeal.yass2.remote.ServiceId<ch.softappeal.yass2.Echo>.service(
...
public fun <A, B, C> ch.softappeal.yass2.remote.ServiceId<ch.softappeal.yass2.GenericService<A, B, C>>.proxy(
    tunnel: ch.softappeal.yass2.remote.Tunnel,
    ...
    object : ch.softappeal.yass2.GenericService<A, B, C> {
        override suspend fun service(
            ...
            tunnel(ch.softappeal.yass2.remote.Request(id, "service", listOf(p1, p2)))
                .process() as C
    }

public fun <A, B, C> ch.softappeal.yass2.remote.ServiceId<ch.softappeal.yass2.GenericService<A, B, C>>.service(
...
public object BinarySerializer : ch.softappeal.yass2.serialize.binary.BinarySerializer() {
    init {
        initialize(
            // kotlin.collections.List: 1
            ch.softappeal.yass2.serialize.binary.BooleanBinaryEncoder, // 2
            ch.softappeal.yass2.serialize.binary.IntBinaryEncoder, // 3
            ch.softappeal.yass2.serialize.binary.StringBinaryEncoder, // 4
            ch.softappeal.yass2.serialize.binary.ByteArrayBinaryEncoder, // 5
            ...
            ch.softappeal.yass2.serialize.binary.BinaryEncoder(
                ch.softappeal.yass2.remote.Request::class, // 14
                { i ->
            ...
            ch.softappeal.yass2.serialize.binary.BinaryEncoder(
                ch.softappeal.yass2.remote.ValueReply::class, // 15
                { i ->
                    writeObject(i.value)
                },
                {
            ...
            ch.softappeal.yass2.serialize.binary.BinaryEncoder(
                ch.softappeal.yass2.remote.ExceptionReply::class, // 16
                { i ->
            ...
            ch.softappeal.yass2.serialize.binary.BinaryEncoder(
                ...
                },
                {
                    ch.softappeal.yass2.coroutines.session.Packet(
                        ...
                        message = readObject() as ch.softappeal.yass2.remote.Message,
                    )
                }
            ),
            ch.softappeal.yass2.serialize.binary.BinaryEncoder(
...
public val StringEncoders: List<ch.softappeal.yass2.serialize.string.StringEncoder<*>> = listOf(
    // kotlin.String: 0
    // kotlin.Boolean: 1
    // kotlin.collections.List: 2
    ch.softappeal.yass2.serialize.string.IntStringEncoder, // 3
    ch.softappeal.yass2.serialize.string.ByteArrayStringEncoder, // 4
    ...
    ch.softappeal.yass2.serialize.string.ClassStringEncoder(
        ch.softappeal.yass2.remote.Request::class, // 13
        { i ->
    ...
    ch.softappeal.yass2.serialize.string.ClassStringEncoder(
        ch.softappeal.yass2.remote.ValueReply::class, // 14
        { i ->
    ...
    ch.softappeal.yass2.serialize.string.ClassStringEncoder(
        ch.softappeal.yass2.remote.ExceptionReply::class, // 15
        { i ->
