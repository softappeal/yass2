...
public fun ch.softappeal.yass2.contract.Echo.proxy(
    ...
    override suspend fun echoGeneric(p1: kotlin.collections.Map<kotlin.String?, ch.softappeal.yass2.contract.Node>): kotlin.collections.Map<kotlin.Int, ch.softappeal.yass2.contract.Node>? {
        return suspendIntercept(ch.softappeal.yass2.contract.Echo::echoGeneric, listOf(p1)) { this@proxy.echoGeneric(p1) } as kotlin.collections.Map<kotlin.Int, ch.softappeal.yass2.contract.Node>?
    }

    override suspend fun echoMonster(p1: kotlin.collections.List<*>, p2: kotlin.collections.List<kotlin.collections.List<kotlin.String?>?>, p3: kotlin.collections.Map<out kotlin.Int, kotlin.String>, p4: kotlin.Pair<*, *>): kotlin.collections.Map<in kotlin.Int, kotlin.String>? {
        return suspendIntercept(ch.softappeal.yass2.contract.Echo::echoMonster, listOf(p1, p2, p3, p4)) { this@proxy.echoMonster(p1, p2, p3, p4) } as kotlin.collections.Map<in kotlin.Int, kotlin.String>?
    }
...
public fun ch.softappeal.yass2.remote.ServiceId<ch.softappeal.yass2.contract.Echo>.service(implementation: ch.softappeal.yass2.contract.Echo): ch.softappeal.yass2.remote.Service =
    ch.softappeal.yass2.remote.Service(id) { functionId, parameters ->
        when (functionId) {
            ...
            2 -> implementation.echoGeneric(parameters[0] as kotlin.collections.Map<kotlin.String?, ch.softappeal.yass2.contract.Node>)
            3 -> implementation.echoMonster(parameters[0] as kotlin.collections.List<*>, parameters[1] as kotlin.collections.List<kotlin.collections.List<kotlin.String?>?>, parameters[2] as kotlin.collections.Map<out kotlin.Int, kotlin.String>, parameters[3] as kotlin.Pair<*, *>)
            4 -> implementation.echoNode(parameters[0] as ch.softappeal.yass2.contract.Node?)
            5 -> implementation.echoNodeRequired(parameters[0] as ch.softappeal.yass2.contract.Node)
            6 -> implementation.echoRequired(parameters[0] as kotlin.Any)
