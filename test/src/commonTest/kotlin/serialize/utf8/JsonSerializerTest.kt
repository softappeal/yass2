...
private val SERIALIZER_SL = JsonSerializer(createUtf8Encoders(), false)
private val SERIALIZER_ML = JsonSerializer(createUtf8Encoders(), true)
...
class JsonSerializerTest {
    ...
    fun properties() {
        ...
        println(assertFailsWith<Exception> { // wrong typ of property intWrapper
            SERIALIZER_SL.readString("""{"#":"Optionals","i":"1","intWrapper":{"#":"A","a":"1"}}""")
        })
        println(assertFailsWith<Exception> { // wrong typ of property intWrapper
